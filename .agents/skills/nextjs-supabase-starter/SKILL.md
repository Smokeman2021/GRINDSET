...
description: Rules and best practices for building a Next.js starter app with Supabase (auth, profiles, RLS, declarative schemas, setup script). Apply when implementing or modifying a starter app with Next.js App Router, Supabase authentication, database migrations, Row Level Security, and CI/CD.
---
